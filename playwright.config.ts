...
export default defineConfig({
  ...
  //tempo máximo para assertions (toBeVisible(), toHaveText()) e tem duração de 5 segundos
  expect:{
    timeout: 5000, //não vale a pena aumentar, pois os testes podem ficar lentos. É mais recomendado o timeout explícito
  },
